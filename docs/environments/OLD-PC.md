# Old PC Environment Audit — 2026-07-29

> Historical record for the previous development PC. Paths and installed
> versions below must not be treated as the current device configuration.
